  ...
  return (
    <label className="block" htmlFor={inputId}>
      ...
      <input
        id={inputId}
        className={[
          "w-full rounded-xl border bg-zinc-800/80 px-4 py-2.5 text-zinc-100 transition-colors placeholder:text-zinc-500 focus:outline-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-500/50 focus-visible:ring-offset-2 focus-visible:ring-offset-canvas",
          error
