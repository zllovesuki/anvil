/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file .dev.vars.example` (hash: 26f18383df0511531809f6768dcc86ea)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_SESSION_TTL_SECONDS" | "AUTH_SESSION_REFRESH_THRESHOLD_SECONDS" | "SESSION_VERSION" | "SANDBOX_TRANSPORT" | "APP_ENCRYPTION_KEY_CURRENT_VERSION" | "APP_ENCRYPTION_KEYS_JSON" | "TESSERA_OIDC_ISSUER" | "TESSERA_OIDC_CLIENT_ID" | "TESSERA_OIDC_CLIENT_SECRET">> {}
}
