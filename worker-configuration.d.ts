/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file .dev.vars.example` (hash: e5534407b394a470e3cf0c84edd1b312)
// Runtime types generated with workerd@1.20260415.1 2026-03-16 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/index");
		durableNamespaces: "ProjectDO" | "RunDO" | "Sandbox";
	}
	interface Env {
		SESSIONS: KVNamespace;
		LOG_TICKETS: KVNamespace;
		DB: D1Database;
		RUN_QUEUE: Queue;
		PUBLIC_LOGIN_RATE_LIMITER: RateLimit;
		PUBLIC_INVITE_ACCEPT_RATE_LIMITER: RateLimit;
		ASSETS: Fetcher;
		...
		SESSION_VERSION: "1";
		PASSWORD_PBKDF2_DIGEST: "SHA-256";
		PASSWORD_PBKDF2_ITERATIONS: "100000";
		SANDBOX_TRANSPORT: "websocket";
		APP_ENCRYPTION_KEY_CURRENT_VERSION: string;
		APP_ENCRYPTION_KEYS_JSON: string;
		TURNSTILE_SITE_KEY: string;
		TURNSTILE_SECRET_KEY: string;
		PROJECT_DO: DurableObjectNamespace<import("./src/worker/index").ProjectDO>;
		RUN_DO: DurableObjectNamespace<import("./src/worker/index").RunDO>;
		Sandbox: DurableObjectNamespace<import("./src/worker/index").Sandbox>;
		RUN_WORKFLOWS: Workflow<Parameters<import("./src/worker/index").RunWorkflows['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_SESSION_TTL_SECONDS" | "AUTH_SESSION_REFRESH_THRESHOLD_SECONDS" | "INVITE_TTL_SECONDS" | "INVITE_TOKEN_BYTES" | "SESSION_VERSION" | "PASSWORD_PBKDF2_DIGEST" | "PASSWORD_PBKDF2_ITERATIONS" | "SANDBOX_TRANSPORT" | "APP_ENCRYPTION_KEY_CURRENT_VERSION" | "APP_ENCRYPTION_KEYS_JSON" | "TURNSTILE_SITE_KEY" | "TURNSTILE_SECRET_KEY">> {}
}
